...
export const StartNodeIcon = (props: React.JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>) => {
    return (
...
export const BombNodeIcon = (props: React.SVGProps<SVGSVGElement>) => {
    return (
        <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
            ...
            <rect x="15.5676" y="11" width="4.28571" height="2.85714" transform="rotate(23.4956 15.5676 11)"
                  fill="#FF0000"/>
            <path
            ...
            <path
                ...
                fill="white"/>
            <path d="M15.7415 11.2857L16.2655 11.5136L15.7143 12.5714L15.2857 12.2857L15.7415 11.2857Z" fill="white"/>
        </svg>
...
export const WeightNodeIcon = (props: React.JSX.IntrinsicAttributes & SVGMotionProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>) => {
    return (
