                    ...
                    <Folder name="mazes">
                        ...
                        <Folder name="wall">
                            ...
                            <File
                                ...
                                Icon={<BatFileIcon />}
                                onClick={() =>
                                    handleBatFileClick(MazeType.GENERATE_BLOCKED_RANDOM_MAZE)
                                }
                            />
                        </Folder>
                        <Folder name="weighted">
                            <File
                                ...
                                Icon={<BatFileIcon />}
                                onClick={() =>
                                    handleBatFileClick(MazeType.GENERATE_WEIGHTED_RIDGES)
                                }
                            />
                            <File
                                ...
                                Icon={<BatFileIcon />}
                                onClick={() =>
                                    handleBatFileClick(MazeType.GENERATE_WEIGHTED_RANDOM_MAZE)
                                }
                            />
                        </Folder>
                    </Folder>
