 ...
 * @constructor
 */
const Folder: React.FC<FolderProps> = ({ children, name }) => {
    ...
    const folderIconClasses = cn(
        ...
        'transition-opacity',
        isExpanded ? 'transform scale-[1.05] opacity-100' : 'transform scale-[0.95] opacity-[0.85]',
    );
    return (
        <div style={style}>
            <div
                className="flex flex-nowrap max-w-2xs items-center gap-1 pt-[3px] pb-[3px]"
                onClick={toggle}
            >
